...
-- --------------------------------------------------
-- Date Created: 03/20/2019 14:41:59
-- Generated from EDMX file: C:\Users\User\Source\Repos\Jamf99\InformationSystemsModel\ModeloParcial\ModeloParcial\ModeloParcial.edmx
-- --------------------------------------------------
...
-- Creating primary key on [Número], [EstudianteId], [CursoGrupo], [CursoAñoSem], [CursoMateriaId] in table 'Parciales'
ALTER TABLE [dbo].[Parciales]
ADD CONSTRAINT [PK_Parciales]
    PRIMARY KEY CLUSTERED ([Número], [EstudianteId], [CursoGrupo], [CursoAñoSem], [CursoMateriaId] ASC);
GO
